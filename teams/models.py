...
class Team(models.Model):
    ...
    captain = models.OneToOneField(Member, related_name='captain_team', on_delete=models.CASCADE, blank=True, null=True, help_text='Капитан')
    assistant = models.OneToOneField(Member, related_name='assistant_team', on_delete=models.CASCADE, blank=True, null=True, help_text='Помощник')
